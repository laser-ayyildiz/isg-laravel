...
<body>
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="#about" class="smoothScroll">İŞLERİMİZ</a></li>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                         <div class="home-text">
                              <h1>Özgür OSGB</h1>
                              <p>İş güvenliği uzmanınız</p>
                              <ul class="section-btn">
                                   <a href="#about" class="smoothScroll"><span data-hover="Daha fazla">Daha
                                             fazla</span></a>
                              </ul>
                         </div>
                    </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-10 col-sm-12">
                         <div class="about-info">
                              <h3>Osgb Nedir?</h3>
                              <h1>Ortak Sağlık Güvenlik Birimi (OSGB), İş Sağlığı ve Güvenliği Hizmetleri yönetmeliği
                                   ile tanımlanmış; en son yasal düzenlemelere göre 1 işçinin dahi çalıştığı sanayiden
                                   sayılan ve sayılmayan her türlü iş yerine; iş yeri hekimi ve iş güvenliği uzmanı
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="project-item">
                              <a href="images/csgb.jpg" class="image-popup">
                                   ...
                                   <div class="project-overlay">
                                        <div class="project-info">
                                             <h1>Özel İş Sağlığı ve Güvenliği Danışmanlık Eğitim Hizmetleri Gıda Turizm
                                             </h1>
                                        </div>
                                   </div>
                              </a>
                              ...
                              <div class="team-item">
                                   ...
                                   <div class="team-overlay">
                                        <ul class="social-icon">
                                             ...
                                             <li><a href="https://www.linkedin.com/in/%C3%B6zg%C3%BCr-f%C4%B1rat-yakut-b99b33101"
                                                       class="fa fa-linkedin"></a></li>
                                        </ul>
                                   </div>
                              </div>
                              <p>Özgür Fırat Yakut</p>
                              ...
                              <div class="col-md-offset-4 col-md-4 col-sm-offset-4 col-sm-4">
                                   <div class="section-btn">
                                        <button type="submit" class="form-control" id="cf-submit" name="submit"><span
                                                  data-hover="Mesajı Gönder">Mesajı Gönder</span></button>
                                   </div>
                              </div>
                         </form>
                    </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-5 col-sm-12">
                         ...
                         <p><a href="tel:0505-624-60-06">0505-624-60-06</a></p>
     ...
     <script src="/dashboard/js/magnific-popup-options.js"></script>
