...
<div class="row">
    ...
    <div class="col-lg-8 pr-3">
        <div class="row" style="height: 780px">
            <div class="card w-100">
                @include('user.company.home.tabs.dokumanlar')
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="row" style="height: 550px">
            <div class="card w-100">
                @include('user.company.home.tabs.bildirimler')
            </div>
        </div>
        <div class="row my-3">
            <div class="card w-100">
                @include('user.company.home.tabs.bilgiler')
            </div>
        </div>
    </div>
</div>
...
<div name="modals">
    @include('user.company.home.modals.zorunlu-dokuman-ekle')
    @include('user.company.home.modals.aylik-dokuman-ekle')
    @include('user.company.home.modals.ekipman-ekle')

    @if ($equipments !== null)
    @include('user.company.home.modals.ekipman-dosyasi-ekle')
    @endif
</div>
@push('scripts')
