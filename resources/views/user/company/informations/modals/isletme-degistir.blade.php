        ...
        <div class="modal-content">
            <form action="{{ route('user.company.updateRequest',['company' => $company, 'user' => auth()->user()]) }}"
                ...
                <div class="modal-c-tabs">
                    @include('user.company.informations.modals.isletme-degistir.tabs')
                    <div class="tab-content">
                        @include('user.company.informations.modals.isletme-degistir.link1')
                        @include('user.company.informations.modals.isletme-degistir.link2')
                        @include('user.company.informations.modals.isletme-degistir.link3')
                    </div>
                </div>
