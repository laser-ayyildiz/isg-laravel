<div class="tab-pane fade show {{ session('tab') == 'genel_bilgiler' ? 'active' : '' }}" id="devlet_bilgileri"
    role="tabpanel" aria-labelledby="db-tab">
    <div class="row col-lg-6">
        <label for="nace_kodu">
            <h4><b>NACE Kodu</b></h4>
        </label>
        <input name="nace_kodu" id="nace_kodu" class="form-control" value="{{ $company->nace_kodu ?? ''}}" required>
