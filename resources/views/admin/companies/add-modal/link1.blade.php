    ...
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <select class="form-control" id="citySelect" name="citySelect" size="1" value="{{ old('citySelect') }}">
                    @if (old('citySelect'))
            ...
            <div class="col-sm-4">
                ...
                <input class="form-control" type="date" placeholder="Anlaşma Tarihi" name="contract_at" id="contract_at"
                    value="{{ old('contract_at') }}">
            </div>
        </div>
    </div>
