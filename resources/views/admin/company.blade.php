...
<div class="card shadow-lg">
                ...
                <div class="modal-body">
                    <form action="../core/uploadReport.php" method="POST" enctype="multipart/form-data">
                        <div class="row col-12">
                            ...
                            <input name="upload_report_name" id="upload_report_name" class="form-control" type="text"
                                maxlength="40" placeholder="Rapor Adı" required>
                        </div>
                        <br>
                        <div class="row col-12">
                            <label for="visit_report_date">
                            ...
                            <input name="upload_report_date" id="upload_report_date" class="form-control" type="date"
                                required>
                        </div>
                        <br>
                        <div class="modal-footer">
    ...
    <div class="modal fade" id="changeCompany" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <form action="{{ route('admin.company.handle',['id' => $company->id]) }}" method="POST">
                    @csrf
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="tel" class="form-control" name="cu_phone" placeholder="Tel: 05XXXXXXXXX"
