<ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" id="eec-tab" data-toggle="tab" href="#evraklari_eksik_calisanlar" role="tab"
            aria-controls="Evrakları Eksik Çalışanlar"><b>Evrakları Eksik Çalışanlar</b></a>
    </li>
    <li class="nav-item">
