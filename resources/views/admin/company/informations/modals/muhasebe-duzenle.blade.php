<div class="modal fade" id="uploadAcc" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.company.upload-accountant', ['company' => $company]) }}" method="POST">
                @csrf
                    ...
                    <div class="row my-3">
                        <div class="col-6">
                            ...
                            <input class="form-control" type="text" name="front_acc_name"
                                value="{{ $accountants['front']->name ?? ''}}" placeholder="Ad Soyad">
                        </div>
                        <div class="col-6">
                    ...
                    <div class="row my-3">
                        <div class="col-6">
                            ...
                            <input class="form-control" type="text" name="out_acc_name"
                                value="{{ $accountants['out']->name ?? ''}}" placeholder="Ad Soyad">
                        </div>
                        <div class="col-6">
                            ...
                            <input class="form-control" type="email" name="out_acc_email"
                                value="{{ $accountants['out']->email ?? '' }}" placeholder="Email">
                        </div>
                    </div>
                    <div class="row my-3">
                        <div class="col-6">
                            ...
                            <input class="form-control" type="phone" name="out_acc_phone"
                                value="{{ $accountants['out']->phone ?? '' }}" placeholder="05XXXXXXXXX" maxlength="11">
                        </div>
                    </div>
                </div>
