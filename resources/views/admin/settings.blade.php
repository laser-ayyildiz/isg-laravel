...
<div class="card shadow-lg border">
    ...
    <div class="card-group">
        <div class="card bg-light"><img class="card-img-top w-50 d-block" style="margin: auto;margin-top:10px;"
                src="assets/img/kurum_profili.png">
            <div class="card-body">
                <h4 class="card-title"><b>Kurum Profili</b></h4>
                <p class="card-text">Kurumunuzun bilgilerini düzenleyin</p><a class="btn btn-primary" role="button"
                    href="/admin/osgb_comp" style="margin-top: 30px;">Düzenle</a>
            </div>
        </div>
        <div class="card bg-light"><img class="card-img-top w-50 d-block" style="margin: auto;"
            ...
            <div class="card-body" style="margin-top:10px;">
                ...
                <p class="card-text">Çalışanlarınızı ve bilgilerini düzenleyin</p><a class="btn btn-primary"
                    role="button" href="/admin/osgb_users" style="margin-top: 30px;">Düzenle</a>
            </div>
        </div>
        <div class="card bg-light"><img class="card-img-top w-50 d-block" style="margin: auto; margin-top:10px;"
            ...
            <div class="card-body">
                ...
                <p class="card-text">Hesap ayarlarınızı düzenleyin</p><a class="btn btn-primary" role="button"
                    href="/admin/profile" style="margin-top: 30px;">Düzenle</a>
            </div>
        </div>
    </div>
</div>
