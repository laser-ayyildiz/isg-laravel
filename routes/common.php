...
Route::get('/get-company-employees-with-files/{company}/{type}', [AjaxPopulateController::class, 'getCompanyEmployeesWithFiles'])->name('get-company-employees-with-files');
